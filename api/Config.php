...
class Config
{
    ...
    // Файл для хранения настроек БД
    public $config_db_file = 'config/config_db.php';
    ...
    {
        // Читаем настройки из файла конфигурации базы
        $db_ini = parse_ini_file(dirname(dirname(__FILE__)) . '/' . $this->config_db_file);
        foreach ($db_ini as $var => $value)
            $this->vars[$var] = $value;
