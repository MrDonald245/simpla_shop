...
class Orders extends Simpla
{
	...
	public function get_order($id)
	{
		...
		$query = $this->db->placehold("SELECT  o.id, o.delivery_id, o.delivery_price, o.separate_delivery,
										  ...
										  o.new_post_recipient_ware_house, o.new_post_recipient_city, o.new_post_document_id,
                                          o.new_post_date_delivery, o.new_post_date_delivery, o.new_post_custom_weight, 
                                          o.new_post_cost_delivery,
                                          o.new_post_name, o.new_post_midle_name, o.new_post_last_name
