...
{	
	...
	{	
        ...
        if($this->settings->new_post_sender_city!='' && $this->settings->new_post_key!=''){
            $this->design->assign('new_post_current_ware_house',$this->settings->new_post_ware_house);
            $new_post_ware_house=$np->getWarehouses($this->settings->new_post_sender_city);
 		...
 		if($this->request->method('POST'))
		{
            ...
            $this->settings->new_post_key = $this->request->post('new_post_key');
            $this->settings->new_post_phone_sender = $this->request->post('new_post_phone_sender');
            $this->settings->new_post_sender_city = $this->request->post('new_post_sender_city');
            $this->settings->new_post_ware_house = $this->request->post('new_post_ware_house');
            $this->settings->new_post_type_pay = $this->request->post('new_post_type_pay');
            $this->settings->new_post_pay = $this->request->post('new_post_pay');
            $this->settings->new_post_back_pay = $this->request->post('new_post_back_pay');
            $this->settings->new_post_min_ob = $this->request->post('new_post_min_ob');
            $this->settings->new_post_weight = $this->request->post('new_post_weight');
